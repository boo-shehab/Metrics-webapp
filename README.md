...
<details>
  ...
  <ul>
    <li><a href="#-Metrics-webapp">📖 Metrics webapp</a></li>
...
**Metrics webapp** is a website for chacking the air pollution in each city. It is a Single Page App (SPA) that allows users to:
...
```sh
  git clone https://github.com/boo-shehab/Metrics-webapp.git
```
